...
const allRows = [
  readProviderCsv("alchemy", "h1", 1),
  readProviderCsv("alchemy", "h1", 3),
  readProviderCsv("alchemy", "h2", 1),
  readProviderCsv("alchemy", "h2", 3),

  readProviderCsv("chainstack", "h1", 1),
  readProviderCsv("chainstack", "h1", 3),
  readProviderCsv("chainstack", "h2", 1),
  readProviderCsv("chainstack", "h2", 3),

  readProviderCsv("quicknode", "h1", 1),
  readProviderCsv("quicknode", "h1", 3),
  readProviderCsv("quicknode", "h2", 1),
